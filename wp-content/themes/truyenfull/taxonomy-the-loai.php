...
<div class="navbar-breadcrumb">
	<div class="container">
		<ul class="breadcrumb">
			<li><a href="<?php echo home_url(); ?>"><i class="glyphicon glyphicon-home"></i> Trang chủ</a></li>
...
<div class="container" id="list-page">
	<div class="row">
		<div class="col-md-9 content">				
			<section class="section">
				...
				<div class="section-content">
					...
					$args = array(
						...
						'theloai'			=> get_queried_object()->term_id,
					);
			...
			<?php hienthiphantrang( get_term_link(get_queried_object()->term_id, 'the-loai'), $args, get_option('sl-truyen') ); ?>
