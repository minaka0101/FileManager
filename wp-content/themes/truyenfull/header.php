		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<h1 class="header-logo">
					<a href="<?php echo esc_url( home_url() ); ?>" title="<?php echo get_option('logo_alt-comic')?>">
						<img src="<?php echo get_option('logo-comic')?>" alt="<?php echo get_option('logo_alt-comic')?>" title="<?php echo get_option('logo_alt-comic')?>">
					</a>
				</h1>
			</div>
			...
			<div class="navbar-collapse collapse">
				...
				<div class="dropdown setting">
					<a data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0)"><span class="glyphicon glyphicon-cog"></span> Tùy chỉnh <span class="caret"></span></a>
